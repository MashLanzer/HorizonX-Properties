...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function renderTable() {
        ...
        if (paginatedItems.length === 0) {
            submissionsBody.innerHTML = '<tr><td colspan="5" style="text-align:center; padding: 2rem;">No se encontraron resultados.</td></tr>';
        } else {
            paginatedItems.forEach(data => {
                ...
                const row = `
                    <tr>
                        ...
                        <td><button class="btn-secondary btn-small">Ver</button></td>
                    </tr>
                `;
